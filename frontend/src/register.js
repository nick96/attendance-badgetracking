...
const RegisterFormSchema = Yup.object().shape({
    ...
    confirmPassword: Yup.string().oneOf([Yup.ref("password")], "Different to password").required("Confirm password is required")
})
    ...
    return (
        <Formik
            ...
            render={({isSubmitting, errors}) => (
                <div>
                    <Form>
                        <Field type="email" name="email" placeholder="Email" variant="outlined"
                               component={TextField}
                               margin="normal"/>
                        <br/>
